    ...
    <footer className="w-full border-t border-white/5 bg-[#0a0d14]/90 backdrop-blur-sm py-8 px-4 mt-auto relative z-20">
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-1.5 text-xs text-slate-400 font-mono">
          ...
          <span>by</span>
          <span className="text-white font-semibold">{BIRTHDAY_CONFIG.teamName}</span>
          <span>for</span>
          <span className="text-zen-400 font-bold">{BIRTHDAY_CONFIG.personName}</span>
        </div>
      </div>
    </footer>
  );
